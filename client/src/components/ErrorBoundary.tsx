                ...
                <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#22223b] via-[#4a4e69] to-[#22223b] p-4">
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            className="px-8 py-4 bg-gradient-to-r from-color-blue to-color-purple text-white font-black text-lg rounded-2xl uppercase tracking-wider shadow-lg hover:shadow-xl transition-all"
                        >
                            Reload Game
                        </motion.button>
                    </motion.div>
