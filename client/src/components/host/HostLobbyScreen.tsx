            ...
            {players.length > 0 && (
                <div className="flex flex-col items-center justify-center w-full">
                    ...
                    <motion.button
                        ...
                        onClick={onStartGame}
                        className="btn btn-primary text-2xl md:text-4xl py-6 md:py-8 px-12 md:px-24 rounded-4xl md:rounded-[3rem] shadow-[0_0_80px_rgba(0,229,255,0.4)] uppercase font-black italic tracking-widest border-t-4 md:border-t-6 border-white/20 animate-pulse-slow mb-8"
                    >
