                    ...
                    {players.map((player, i) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="glass p-8 rounded-[3rem] flex flex-col items-center gap-6 border-white/10 shadow-xl min-w-[280px] hover:scale-110 transition-transform duration-300"
                                style={{
                                    border: `3px solid ${avatarColor}40`,
                                    boxShadow: `0 30px 60px -15px ${avatarColor}30`
                                }}
                            >
                                <div className="w-32 h-32 bg-white/5 rounded-[2rem] flex items-center justify-center shadow-inner border border-white/10 overflow-hidden">
